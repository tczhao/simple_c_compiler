...
// Lexer tokens and classes (operators last and in precedence order)
enum {
...
void function_declaration() {
    ...
    match('{');
    function_body();
    //match('}');                 //  handles by global_declaration
...
void function_parameter() {
    ...
    // calculate position of pointer bq
...
int eval() {
    ...
    while(1) {
        ...
        else if (op == OR)  ax = *sp++ | ax;                                  // Standard Maths
        ...
        else if (op == EXIT) { printf("exit(%d)", *sp); return *sp;}          // Built in instructions
